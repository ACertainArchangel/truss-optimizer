"""
Unit test to verify axial force functions are truly linear.
This validates the assumption that internal axial forces scale linearly with applied load,
which is critical for the PyTorch optimization model.
"""
