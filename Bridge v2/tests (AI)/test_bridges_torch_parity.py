...
class TestBridgesTorchParity(unittest.TestCase):
    ...
    def _compare_failure_loads(self, params, rel_tol=1e-4, abs_tol=1e-6):
        """Helper: compare torch vs parametric failure loads for given params.
        Note: Uses slightly looser tolerance to account for different numerical methods (clamping vs where).
        """
