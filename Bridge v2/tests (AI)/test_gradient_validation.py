"""
Unit tests for gradient validation of the torch implementation.
Tests that automatic differentiation matches finite differences and that all parameters have proper gradient flow.
"""
