"""
Unit test to ensure pratt_analyse.py and pratt_analyse_v2.py produce identical results.
"""
...
class TestAnalyseParity(unittest.TestCase):
    """Test that both analysis scripts produce identical failure load calculations."""
