"""Post-process optimization trials: compute means/std devs from trial JSON files."""
...
def main(display_unit="m"):
    """Run post-processing pipeline. display_unit: 'm', 'cm', 'in', or 'ft'."""
    print("=" * 80)
    print("BRIDGE OPTIMIZATION POST-PROCESSING")
    print("=" * 80)
    trials = load_trial_data("trials<OVERRIDE>")
