...
@deprecated(
    "This class is a relic from a failed experement and has been abandoned.",
    category=DeprecationWarning,
)
class PrattTrussV2(BaseTruss):
    def __init__(
        self,
        material,
        length,
    ...
    def generate_members(self):
        ...
        members = [
            ...
            TensionMember(
                ...
                a=(
                    self.parameters["incline_thickness"]
                    * self.parameters["incline_depth"]
                    * sin(self.parameters["angle"]) ** 2
                    * cos(self.parameters["angle"])
                )
                / (
                    2
                    * self.parameters["incline_thickness"]
                ...
                * (self.parameters["height"] / tan(self.parameters["angle"]))
                + (
                    0.5
                    - (
                        self.parameters["incline_thickness"]
    ...
    def generate_report(self):
        return "Write something here lol."
    ...
    def clamp_params_to_valid_ranges(self, min_top_size_in_meters=0):
        with torch.no_grad():  # Because this is none of the computation graph's business
            self.parameters["angle"].clamp_(
                ...
                + 1e-3
            )  # Adding a wee bit because it will make it taste better.
