    ...
    **kwargs,
    ...
    def euler_F_crit(E, I, K, L, a_coeff, area, b_coeff=0, c=0):
        ...
        b_abs = (
            ...
            else torch.tensor(abs(b_coeff), dtype=dtype, device=device)
        )
    ...
    failure_loads["mid_vert_buckle"] = euler_F_crit(E, I_mid_in, K, L_mid_vert, a_mid, A_mid)
    ...
    failure_loads["side_vert_buckle"] = euler_F_crit(E, I_side_in, K, L_side_vert, a_side, A_side)
